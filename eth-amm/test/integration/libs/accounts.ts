...
/**
 * Helper function to mint USDC to test accounts
 * Call this in test setup to give accounts USDC for trading
 */
export async function mintUSDCToAccounts(
	walletClient: any,
	usdcAddress: Address,
	usdcAbi: any,
	amount: bigint = 1_000_000n * 10n ** 6n, // Default: 1M USDC per account
) {
	...
	console.log(`\n💰 Minting ${amount / 10n ** 6n} USDC to ${accountList.length} test accounts...`)
